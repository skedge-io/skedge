              ...
              <div className="col-md-10 col-lg-8 text-center p-60px-tb sm-p-30px-tb">
                <div className="home-text-center">
                  ...
                  <div className="app-btn-set">
                    {this.props.auth ?<Link className="m-btn m-btn-white" to="/dashboard">Go to Dashboard</Link>  : <a href="https://www.skedge-api.com/auth/google" className="m-btn m-btn-white">
                      Try for free
                    </a> }
                  </div>
                </div>
