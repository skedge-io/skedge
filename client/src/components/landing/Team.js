    ...
    return (
      <div>
        ...
        <div className="team-card-container">
          ...
          <div id="team-three" className="team-card" onClick={() => this.handleTeamClick('Johnathen Chen is a full stack web and iOS developer with an emphasis on design and a passion for UX. His work is featured in several apps on the App Store, and he brings a 21st century mindset to design. He serves Skedge as a designer and front end engineer.')}></div>
        </div>
      </div>
    )
  }
