  ...
  renderContent() {
    switch (this.props.auth) {
      case null:
        return (
          <a
            className="cfd-cta-2 no-mobile-padding hoverable waves-effect waves-blue"
            href="./auth/google"
          >
            Try For Free
          </a>
      ...
      <div className="no-mob-nav">
        ...
        <div className="heroContent" style={{ textAlign: "center" }}>
          ...
          <div className="bottom-align container">
            <a href="#down">
              <i className="scroll-icon material-icons">keyboard_arrow_down</i>
            </a>
          </div>
        </div>
        ...
        <div id="down" className="whyWeDo">
          <div className="whyWeDoContent">
            <h3 className="no-margin">
              What extra value does your Appointment scheduling software bring
              your business?
            </h3>
            <p>
        ...
        <div className="threeBenefits">
          ...
          <div className="threeBenefitItems">
            <div className="benefitItem">
              <h1 className="icon">
                <i className="material-icons icon">phone_iphone</i>
              </h1>
              <h4 className="bene-text">Works anywhere</h4>
              <p className="b-p">
                On a phone? Browsing a tablet? Schedule appointments anywhere
                you go.
              </p>
            </div>
            <div className="benefitItem">
              <h1 className="icon">
                <i className="material-icons icon">flash_on</i>
              </h1>
              <h4 className="bene-text">Fast and easy</h4>
              <p className="b-p">
                Skedge is almost twice as fast as it's competitors, and it's so
                easy you don't even have to train your employees on how to use
                it!
              </p>
            </div>
            <div className="benefitItem">
              ...
              <p className="b-p">
                If you decide Skedge isn't for you - no problem. No commitment.
          ...
          <div className="cta-cont">
            <a
              className="cfd-cta hoverable waves-effect waves-blue"
              href="./auth/google"
            >
              Sign Up
            </a>
        ...
        <div className="clients">
          <div className="client-content">
            <p className="price-text">
              Skedge is expecting to launch at the end of Fall, 2018.
            </p>
          </div>
        </div>
        ...
        <div className="reminders">
          <div className="reminderText">
            <div>
              Send custom text reminders to combat no shows! A day before, an
              hour before, whatever you decide.
            </div>
            <a
              className="cfd-cta-2 no-mobile-padding hoverable waves-effect waves-blue"
              href="./auth/google"
          ...
          <div className="reminderImages">
            <img
              alt="skedge text campaign"
              className="img-phone"
              src="https://preview.ibb.co/dKSwMy/imageedit_1_5925980519.png"
            />
          </div>
        </div>
        ...
        <div className="clients">
          <div className="client-content">
            <p className="price-text">
              Skedge can sync your appointments to Google and Outlook Calendar.
            </p>
          </div>
        </div>
        ...
        <div className="more-reviews">
          <div className="reviewImages">
            <img
              alt="skedge review text campaign"
              className="img-phone-2"
              src="https://image.ibb.co/gMaVGy/imageedit_7_3488219439.png"
            />
          </div>
        ...
        <div className="repeat-business">
          <div className="reminderText">
            <div>
              Gain <b>repeat business</b> by offering customers{" "}
              <b>incentives</b> to keep scheduling appointments with you.
            </div>
            <a
              className="cfd-cta-2 no-mobile-padding hoverable waves-effect waves-blue"
              href="./auth/google"
            ...
            <h5 className="skedgememo">
              Skedge.io is currently in alpha stage development. Create an
              account to stay updated on our development process, and be the
              first to know when skedge is production ready.
            </h5>
          </div>
        </div>
